...
const Comment = ({ threadId, currentUserImg, currentUserId }: CommentProps): React.JSX.Element => {
    ...
    const onSubmit = async (values: z.infer<typeof CommentValidation>): Promise<void> => {
